<template>
    ...
    <div class="bg-orange py-[30px] pb-[100px] lg:py-[100px]  relative after:absolute after:top-[-92px] after:right-0 after:left-0 after:w-full after:mx-auto after:bg-curveOrange after:bg-no-repeat after:bg-center after:bg-[length:2560px_92px] after:h-[92px]">
        <div class="container mx-auto px-[15px] ">
            <div class="flex items-center justify-center mb-8">
                <h1 class="font-hermes text-white text-[33px] leading-[35px] tracking-[-0.33px] md:text-[48px] md:leading-[50px] md:tracking-[-0.48px] uppercase text-center ">
                    <span class="text-blue">PARTICIPAR</span> ES MUY FÁCIL
                </h1>
            </div>
