<template>
    ...
    <div class="container mx-auto px-[15px] py-8" :style="{ marginTop: headerHeight + 'px' }">
        <div class="box bg-[#FEDA1C] rounded-[40px] lg:rounded-full w-12/12 lg:w-9/12 mx-auto text-center py-4 shadow-lg px-8">
            <p class="font-montserrat font-extrabold rem:text-[22px] rem:leading-[28px] text-red uppercase">PROMOCIÓN FINALIZADA</p>
            <p class="font-montserrat rem:text-[22px] rem:leading-[28px] text-black">GRACIAS A TODOS POR PARTICIPAR. ¡OS ESPERAMOS EN LA PRÓXIMA!</p>
        </div>
    </div>
