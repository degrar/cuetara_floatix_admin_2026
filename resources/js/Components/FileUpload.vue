...
<template>
    <div class="relative">
        ...
        <div class="">
            <div class="relative bg-slate-100 text-black font-montserrat text-sm std-input w-full rounded-[6px] appearance-none px-2 py-3 rem:h-[45px] rem:mt-[5px] rem:mb-[5px] border-2 border-white placeholder-white placeholder-opacity-100 focus:placeholder-opacity-50 focus:outline-none focus:border-white focus:shadow-none" :class="{ '!border-red text-red': error }">
