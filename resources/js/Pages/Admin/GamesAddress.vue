<template>
    <Page title="Participaciones" :pagination-links="links">
        ...
        <template #content>
            ...
            <GameListAddress :data="data" :header="tableHeader" @deleted="onItemDeleted" />
...
<script setup>
import GameListAddress from "@/Partials/Admin/Games/GameListAddress.vue";
...
const onItemDeleted = id => {
    //data.value = props.items.data.filter(e => e.id !== id);
