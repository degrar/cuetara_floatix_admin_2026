        ...
        <div class="bg-white py-[50px]">
            <div class="container mx-auto px-[15px] flex justify-center items-center flex-col py-[40px] lg:flex-row lg:py-[80px] ">
                <div class="w-12/12  pt-[15px]">
                    ...
                    <p class="pt-4 block">El valor estimado del premio es de 100€ (IVA incluido). </p>
                    ...
                    <p>En ningún caso, se aceptarán ni se gestionarán cesiones del Premio a terceros ni tendrán los participantes ganadores el derecho a recibir su valor en metálico.</p>

                    <h4>VII DISPOSICIONES GENERALES Y LIMITACIÓN DE RESPONSABILIDAD</h4>
                    <p>FERRERO se reserva el derecho de variar alguno de los premios y/o características de estos, si fuera necesario, por cualquier causa durante todo el Periodo Promocional.</p>
                    <p>FERRERO hará todo lo posible por evitar el suministro de los datos o documentos incorrectos o falsos por parte de los participantes. Asimismo, FERRERO no se hará responsable de la veracidad de los datos o documentos que los participantes faciliten. Por consiguiente, si los datos o documentos facilitados no fueran correctos o tuvieran errores, FERRERO no se hará responsable de no poder contactar con los participantes para gestionar con ellos la entrega del Premio y de todas las incidencias que pudieran derivarse de la incorrección o falsedad de los datos o documentos suministrados.</p>
                    ...
                    <p>Las bases permanecerán publicadas durante el Período Promocional en la página oficial https://www.kinder.com/es/es.</p>
                    ...
                    <p>En todo caso, para más información, todos los participantes podrán consultar la información adicional y detallada https://www.kinder.com/es/es</p>

                    <h4>XI. RÉGIMEN FISCAL</h4>
