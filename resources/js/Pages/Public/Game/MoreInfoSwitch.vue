            ...
            <div class="w-12/12 lg:w-10/12 mx-auto">
                <div class="flex flex-col lg:flex-row items-center justify-center mb-10">
                    ...
                    <div class=" w-12/12 lg:w-9/12">
                        <h1 class="text-red font-ferry uppercase text-2xl lg:text-4xl rem:tracking-[0.15px] mt-6 text-center lg:text-left">¡HAS GANADO UNA <sup>©</sup>NINTENDO SWITCH!</h1>
                ...
                <div class="w-12/12 mx-auto">
                    ...
                    <form @submit.prevent="submitForm" class="mx-auto">
                        <h4  v-if="type == 0" class="w-full font-ferry text-base lg:text-lg mt-4 text-black border-black border-b-[1px] mt-3 mb-4 text-center lg:text-left">Dirección postal donde quieres recibirla</h4>
                        ...
                        <h4 class="w-full font-ferry text-base lg:text-lg mt-4 text-black border-black border-b-[1px] mt-3 mb-4 text-center lg:text-left">Tus datos personales</h4>
