    ...
    <tr>
        <td>
            <table class="row row-1" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ececec;">
                ...
                <tr>
                    <td>
                        <table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #1295B7; color: #ffffff; width: 600px;" width="600">
                            <tbody>
                            <tr>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-top:20px;padding-right:60px;padding-bottom:20px;padding-left:60px;">
                                                ...
                                                <div style="text-align: center">
                                                    <a href="{{ $formLink }}">
                                                        <img src="{{ asset('assets/email/raffle/cta_raffle.png') }}" alt="Ir al formulario" style="height: 67px; width: 336px;" height="67" width="336">
                                                    </a>
                                                </div>
                                                <br>
                                                <p style="color: #ffffff;text-align: center;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px;">
                                                ...
                                                <div style="text-align: center">
                                                    <a href="{{ $formLink }}">
                                                        <img src="{{ asset('assets/email/raffle/logo.png') }}" alt="Ir al formulario" style="height: 34px; width: 80px;" height="34" width="80">
                                                    </a>
                                                </div>
                                                <br>
                                            </td>
